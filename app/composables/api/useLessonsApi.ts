...
export function createLesson(
  ...
  return $backendFetch<LessonResponse>(`/lessons`, { method: 'POST', body: payload })
}

export function createLessonsBulkSchedule(
  payload: BulkScheduleRequestPayload,
): Promise<BackendResult<LessonResponse[]>> {
  return $backendFetch<LessonResponse[]>(`/lessons/bulk-schedule`, { method: 'POST', body: payload })
}
...
export function updateLesson(
  ...
  return $backendFetch<LessonResponse>(`/lessons/${toValue(lessonId)}`, {
    method: 'PATCH',
    body: payload,
  })
}
...
export function deleteLesson(
  ...
  return $backendFetch<void>(`/lessons/${toValue(lessonId)}`, { method: 'DELETE' })
}
